...
else if (index1 <= 710 && index2 <= 1350)
        disp('2 was pressed')
else if (index1 <= 710 && index2 <= 1500)
        disp('3 was pressed')
    
else if (index1 <= 780 & index1 <= 1220)
        disp('4 was pressed')
else if (dt1 <= 780 & dt2 <= 1350)
        
 else if (index1 <= 710 && index2 <= 1350)
        disp('5 was pressed')
        
else if (index1 <= 780 && index2 <= 1500)
        disp('6 was pressed')
    
else if (index1 <= 870 & index1 <= 1220)
        disp('7 was pressed')
else if (index1 <= 780 & index2 <= 1350)       
        disp('8 was pressed')
       
 else  (index1 <= 780 & index2 <= 1500)       
       disp('9 was pressed')
 end
 end
